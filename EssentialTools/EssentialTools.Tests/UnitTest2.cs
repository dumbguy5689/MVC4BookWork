...
namespace EssentialTools.Tests
{
        ...
        public class UnitTest2
        {
            ...
            private Product[] createProduct(decimal value) { return new[] { new Product { Price = value * -1 } }; }
            ...
            public void Pass_through_Variable_Discounts()
            {
                //arrange
                Mock<IDiscountHelper> mock = new Mock<IDiscountHelper>();
                mock.Setup(m => m.ApplyDiscount(It.IsAny<decimal>())).Returns<decimal>(total => total + 1);
